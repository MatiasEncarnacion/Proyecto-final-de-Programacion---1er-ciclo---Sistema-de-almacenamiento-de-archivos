...
import views.tablas.ModeloFiltroBorrados;
...
public class Matias1 extends javax.swing.JFrame {
    ...
    private ModeloFiltroBorrados mfb = new ModeloFiltroBorrados();
    ...
    public Matias1() {
        ...
        tabla();
        cargarTabla();
        tblobjetosborrados.setVisible(false);
    ...
    private void cargarBorrados() {
        if (u.listarborrados() != null || u.listarborrados().length > 0) {
            mfb.setData(u.listarborrados());
            tblobjetosborrados.setModel(mfb);
            tblobjetosborrados.updateUI();
            System.out.println("filtro borrar");
        }
    }
    ...
    private void guardar() {
        if (txtnombre.getText().isEmpty() || txtdireccion.getText().isEmpty()) {
            ...
            if (u.guardar_archivo(txtnombre.getText(), txtdireccion.getText(), lblnombre.getText())) {
                Utilidades.copy(txtdireccion.getText(), txtnombre.getText());
...
//cristian
    ...
    DefaultTableModel filtrarb = new DefaultTableModel();
    ...
    private void initComponents() {
        ...
        tblobjetosborrados = new javax.swing.JTable();
        ...
        tblobjetosborrados.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane2.setViewportView(tblobjetosborrados);
        ...
        btnagregar.setBounds(280, 110, 135, 33);
        ...
        Lista.add(btnborrar);
        btnborrar.setBounds(530, 140, 120, 30);
        ...
        btnescogerarchivo.setBackground(new java.awt.Color(255, 255, 255));
        btnescogerarchivo.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnescogerarchivo.setForeground(new java.awt.Color(0, 0, 0));
        btnescogerarchivo.setText("Escoja archivo");
        btnescogerarchivo.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btnescogerarchivo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnescogerarchivoActionPerformed(evt);
            }
        });
        jPanel1.add(btnescogerarchivo);
        btnescogerarchivo.setBounds(280, 160, 140, 30);
    ...
    private void btnescogerarchivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnescogerarchivoActionPerformed
        ...
        Integer op = fc.showOpenDialog(this);
        if (op == JFileChooser.APPROVE_OPTION) {
            File f = fc.getSelectedFile();
            txtnombre.setText(f.getName());
            txtdireccion.setText(f.getAbsolutePath());
        }
    ...
    private static javax.swing.JTable tblobjetosborrados;
